package com.kibabii_project.face_recognition.Security.Filter;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // this allow CORS preflight requests
        ...
        if (requestPath.contains("/register")
                ...
                || requestPath.contains("/authenticate")
                || requestPath.contains("/api/verify")) {
        ...
        // Print authenticated user safely
